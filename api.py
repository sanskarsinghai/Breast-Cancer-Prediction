...
def hello_world():
    ...
    kn1=predict.breast_cancer_prediction_kn(test_features)
    kn2=predict.breast_cancer_prediction_kn(test_features2)
    ...
    'K-nearest Neighbors Result':{'First Feature':{'Features':test_features,'Result':kn1},'Second Feature':{'Features':test_features2,'Result':kn2}}
    })
